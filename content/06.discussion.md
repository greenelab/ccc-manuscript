...
Not only linear correlation coefficients might be helpful in the field of genetic studies, but also more efficient correlation coefficients, like the CC model.
