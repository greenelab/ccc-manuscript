...
We compute $P$-values using permutation tests, which are computationally intensive; in the future, we plan to explore efficient permutation approaches such as those based extreme value theory [@doi:10.1093/bioinformatics/btp211].
