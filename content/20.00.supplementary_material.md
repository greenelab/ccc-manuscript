...
We compared our CCC coefficient with MIC [@pmid:22174245], a popular nonlinear method that can find complex relationships in data, although it is very computationally intensive [@doi:10.1098/rsos.201424].
...
Then we performed the same analysis on the distribution of coefficients (as in the main text), shown in Figure @fig:dist_coefs_mic.
