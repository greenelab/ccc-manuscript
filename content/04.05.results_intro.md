...
Asterisks in legends indicate the significance of the correlation values: $P<0.05$ (\*), $P<0.01$ (\*\*), and $P<0.001$ (\*\*\*).
](images/intro/relationships.svg "Different types of relationships in data"){#fig:datasets_rel width="100%"}

FIGURE: 
- CCC with 10k permutations
- CCC does not capture Anscome II as significant due to sample size (see other quadratic relationship below)
