...
An efficient not-only-linear correlation coefficient based on machine learning is able to accurately identify linear patterns in data, while also recognizing nonlinear relationships and outliers.
